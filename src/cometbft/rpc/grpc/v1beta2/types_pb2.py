...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cometbft/rpc/grpc/v1beta2/types.proto',
  package='cometbft.rpc.grpc.v1beta2',
  syntax='proto3',
  serialized_options=b'Z:github.com/cometbft/cometbft/api/cometbft/rpc/grpc/v1beta2',
  ...
  ,
  dependencies=[cometbft_dot_rpc_dot_grpc_dot_v1beta1_dot_types__pb2.DESCRIPTOR,cometbft_dot_abci_dot_v1beta2_dot_types__pb2.DESCRIPTOR,])
...
_RESPONSEBROADCASTTX = _descriptor.Descriptor(
  ...
  full_name='cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='check_tx', full_name='cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx.check_tx', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='deliver_tx', full_name='cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx.deliver_tx', index=1,
...
_RESPONSEBROADCASTTX.fields_by_name['check_tx'].message_type = cometbft_dot_abci_dot_v1beta2_dot_types__pb2._RESPONSECHECKTX
_RESPONSEBROADCASTTX.fields_by_name['deliver_tx'].message_type = cometbft_dot_abci_dot_v1beta2_dot_types__pb2._RESPONSEDELIVERTX
...
ResponseBroadcastTx = _reflection.GeneratedProtocolMessageType('ResponseBroadcastTx', (_message.Message,), {
  ...
  '__module__' : 'cometbft.rpc.grpc.v1beta2.types_pb2'
  # @@protoc_insertion_point(class_scope:cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx)
  })
...
_BROADCASTAPI = _descriptor.ServiceDescriptor(
  name='BroadcastAPI',
  full_name='cometbft.rpc.grpc.v1beta2.BroadcastAPI',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='cometbft.rpc.grpc.v1beta2.BroadcastAPI.Ping',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='BroadcastTx',
    full_name='cometbft.rpc.grpc.v1beta2.BroadcastAPI.BroadcastTx',
    index=1,
    containing_service=None,
